...
import com.example.appbanmypham.activity.FaceCareActivity;
import com.example.appbanmypham.activity.MainActivity;
...
public class DanhMucFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgFaceCare = view.findViewById(R.id.imgFaceCare);
        imgFaceCare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), FaceCareActivity.class);
